...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", get_random_secret_key()) # "django-insecure-fje(51+dehckv@c=y_x&!ekl(t2ht1-ldjgaer14e7cizunf08"
...
STATIC_URL = "static/"
STATIC_ROOT = os.path.join(BASE_DIR, "monolith", "staticfiles")
